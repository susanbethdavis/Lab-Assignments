...
Use `group_by(experience)` along with the pipe `%>%` to output the most common amount of years of experience along with the number of occurrences found in the data. The most common value for years of experience is 9 years and occurs 654 times. Fill in the blanks with the correct answers, and change `eval=True` to `eval=False` and print out the output that led you to your answer.
...
The years of experience seem to decrease (increase/decrease) as the years of schooling increases. Is this what you expected to see? No (yes/no). 
...
I hypothesize that there is a negative relationship between years schooled and years experience because people who finished school earlier were able to enter the work force sooner then people with more schooling. 
...
Because there is no overlap between the upper bounds of the femlae interval and the lower bound of the male interval we have evidence that these means are significantly different from each other. 
...
Men with 12 to 16 years of school get paid more then women with the same amount of schooling. As experience changes with these same parameters men tend to typically still get paid more on average. This pattern is consistent across most school and experience combinations. 
...
The female plot is darker and this implies there is less deviation around the mean as compared to the male plot which has greater variability around the mean. 
...
This extreme contrast implies that for female workers with 5 years of experience the average value encapsulates a typical individual somewhat accurately. Men however have a very light color in this region, suggesting, their mean value for this region does not represent the typical individual as well. 
